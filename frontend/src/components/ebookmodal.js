...
//     try {
//       await axios.post("http://localhost:8080/ebook", formData);
...
//           </div>
          // <div className="">
          //   <p className="text-center"><input type="checkbox"/> Subscribe to HubSpot's marketing blog</p>
          //   <p className="ps-lg-5 pe-lg-5 pb-lg-5 p-2">We're committed to your privacy. HubSpot uses the information you provide to us to contact you about our relevant content, products, and services. You may unsubscribe from these communications at any time. For more information, check out our <a href="##">Privacy Policy</a>. To unsubscribe from Jasper's communications, see their <a href="##">Privacy Policy</a></p>
          // </div>
...
const AnimatedModal = ({
  ...
  const handleSubmit = async () => {
    try {
      ...
      axios
      .post("http://localhost:8080/sendotp", formData)
      .then((res) => {
        if (res.status === 200) {
      ...
      // setErrorMessage("sEmail not exist");
      console.error("Error submitting form data:", error);
    }
    onRequestClose();
    alert("Data submitted and Ebook may received mail successfully", formData);
  };
