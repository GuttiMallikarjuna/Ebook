...
const Footer = () => {
  ...
  return (
    <>
    <div className='d-md-flex gap-lg-4 justify-content-between mt-2 footer1 ps-lg-5 pe-lg-5 pt-lg-4 p-2 bg-light'>
        <div className="nasscom">
          <img src="https://www.infomericainc.com/Content/images/logo-footer.png" height="40px" alt="NASSCOM Logo" />
          <p className='p-0'>Infomerica is a Software Development and Systems Integration company, one of the fastest growing companies that is committed to help our customers grow and move forward in every aspect of their business.</p>
        </div>
        ...
        <div className="getintouch">
          ...
          <p><a href="mailto:{datatodisplay.email}" className='text-decoration-none'><i className="bi bi-envelope-fill"></i>&nbsp;:&nbsp;info@infomericainc.com</a></p>
